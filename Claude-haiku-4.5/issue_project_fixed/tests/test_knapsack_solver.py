...
class TestKnapsackSolver(unittest.TestCase):
    ...
    def test_basic_example(self):
        ...
        Expected: max_value = 13 (items with weights 2,3,5 for optimal value)
        ...
        # Fixed: correct expected value is 13 (items 0,1,3: weights 2+3+5=10, values 3+4+6=13)
        self.assertEqual(result, 13, 
                        "Should select items 0,1,3 with weight 10 and value 13")
...
class TestKnapsackWithItems(unittest.TestCase):
    ...
    def test_basic_with_items(self):
        ...
        Fixed expected value is 13 (not 10).
        """
        capacity = 10
        weights = [2, 3, 4, 5]
        values = [3, 4, 5, 6]
        ...
        # Fixed: correct expected value is 13
