...
def knapsack(capacity, weights, values):
    ...
    """
    # Input validation - BUGGY VERSION
    # Bug: The condition incorrectly uses 'or' instead of proper validation
    # This causes valid inputs to be rejected!
...
def knapsack_with_items(capacity, weights, values):
    ...
    # Reconstruct solution (simplified - won't work due to bug)
    return max_value, []
